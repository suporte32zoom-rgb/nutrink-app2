...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header 
      className="bg-[#0a0712] text-white border-b border-purple-900/30 sticky top-0 shadow-lg shadow-black/60 pt-[max(0.5rem,env(safe-area-inset-top,0px))] pb-2 sm:pb-3 px-2 sm:px-6 lg:px-8 transition-all overflow-x-hidden"
      style={{ zIndex: 1000 }}
    >
