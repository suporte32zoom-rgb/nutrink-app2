...
const navegarParaTelaTool: FunctionDeclaration = {
  ...
  description: "Navega e abre uma seção/tela específica no sistema NutrinK (/dashboard, /pacientes, /agenda, /planos-alimentares, /antropometria, /exames, /prescricoes, /configuracoes)",
  parameters: {
    type: Type.OBJECT,
    properties: {
      secao: { 
